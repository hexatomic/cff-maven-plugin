...
public class CreateFromDependenciesMojo extends AbstractMojo {
  ...
  private static final String P2_PLUGIN_GROUP_ID = "p2.eclipse-plugin";
  ...
  private static final HttpUrl DEFINITIONS_ENDPOINT =
  ...
  private Map<String, Object> createReference(Artifact artifact,
